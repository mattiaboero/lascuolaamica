...
[![Domande](https://img.shields.io/badge/domande-9.741-orange.svg)](https://lascuolaamica.it)
[![Gratuito](https://img.shields.io/badge/accesso-gratuito%20%26%20senza%20registrazione-yellow.svg)](https://lascuolaamica.it)

Piattaforma educativa gratuita per la scuola primaria italiana. Quiz a risposta multipla su 8 materie, 4 classi, 9.741 domande, più due giochi — senza registrazione, senza tracciamento, accessibile anche offline.
...
- **9.741 domande** su 8 materie, coerenti con le Indicazioni Nazionali per la scuola primaria
