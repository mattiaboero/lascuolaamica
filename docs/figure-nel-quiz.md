...
- **Il lato non deve toccare nessun numero, alone compreso.** Soglia della revisione F9: almeno 3 unità fra il bordo del lato (mezzo tratto 2,5) e il riquadro della cifra allargato dell'alone (2,5). Con questa soglia nessun angolo multiplo di 10 è libero con le etichette standard: si sposta di poco lungo l'arco, lontano dal lato, solo il numero che tocca (2-3,5°, 3-5 unità), e resta accanto alla sua tacca.
