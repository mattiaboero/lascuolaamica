...
const OPTIONAL_PRECACHE_URLS = [
  ...
  '/assets/villaggio/casa.png',
  '/assets/villaggio/fattoria.png',
  '/assets/villaggio/mucche.png',
  '/assets/villaggio/parco-giochi.png',
  '/assets/villaggio/negozio-di-torte.png',
  '/assets/villaggio/farmacia.png',
  '/assets/villaggio/pompieri.png',
  '/assets/villaggio/chiesa.png',
  '/assets/villaggio/moschea.png',
  '/assets/villaggio/scuola-elementare.png',
  '/assets/villaggio/scuola-media.png',
  '/assets/villaggio/liceo.png',
  '/assets/villaggio/uffici.png',
  '/assets/villaggio/ospedale.png',
  '/assets/villaggio/stadio.png',
  '/assets/villaggio/universita.png',
  '/assets/villaggio/castello.png',
